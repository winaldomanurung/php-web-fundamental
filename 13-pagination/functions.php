...
function registrasi($data)
{
  ...
  // agar password bisa gunakan karakter ''
  ...
  // hash password
  // PASSWORD_DEFAULT merupakan algoritma hashing nya
  ...
  return mysqli_affected_rows($conn); //menghasilkan 1 jika success, -1 jika error
}
